...
export class PerformancePanel {
  ...
  readonly groups = computed(() => {
    ...
    // Start the worst list after the best one. Taking the last SHOWN outright
    // would repeat rows whenever fewer than 2 * SHOWN holdings are held, and
    // with a single holding it would appear as both best and worst.
